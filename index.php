...
<head>
    ...
    <meta name="description" content="Portfolio de Luhan Guiggia--Milon, étudiant en BUT Informatique à l'IUT de Lannion. Découvrez mon parcours, mes compétences et mes projets.">
...
<body>
    ...
    <section id="parcours-overlay">
        ...
        <div id="connexing-overlay" hidden>
        ...
        <div id="envoliis-overlay" hidden>
            <div class="envoliis-content">
                ...
                <p>En 2021, j'ai eu une nouvelle opportunité de faire un stage d'observation dans l'entreprise Envoliis. <br>
                    Durant la semaine qu'ils m'ont offert, j'ai pu observé plusieurs métiers tel qu'informaticien, etc...<br> 
                    Cela m'a permis de découvrir les composants de serveur, d'avoir eu la chance de visiter un
                    datacenter et de déplacer des machines virtuels.</p>
            ...
            <h2>À propos de moi</h2>
                ...
                <div>
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3.33325 3.33325L27.4999 9.16659L29.9999 21.6666L21.6666 29.9999L9.16659 27.4999L3.33325 3.33325ZM3.33325 3.33325L15.9766 15.9766M19.9999 31.6666L31.6666 19.9999L36.6666 24.9999L24.9999 36.6666L19.9999 31.6666ZM21.6666 18.3333C21.6666 20.1742 20.1742 21.6666 18.3333 21.6666C16.4923 21.6666 14.9999 20.1742 14.9999 18.3333C14.9999 16.4923 16.4923 14.9999 18.3333 14.9999C20.1742 14.9999 21.6666 16.4923 21.6666 18.3333Z" stroke="#FE9B01" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <h3>Créatif</h3>
                </div>
                <div>
...
<script>
    ...
    openButtons.forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            if (modal) {
                modal.classList.add('active'); // Ouvre avec l'animation
            }
        });
    });
    ...
    closeButtons.forEach(btn => {
        btn.addEventListener('click', () => {
            const modal = btn.closest('[id$="-overlay"]');
            if (modal) {
                modal.classList.remove('active'); // Ferme avec l'animation
            }
        });
    });
</script>
